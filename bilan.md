...
On réutilise les [notes du cours Profession intégrateur pour les commandes UNIX](documents/professionIntegrateur_notes_UNIX-ssh.pdf)
...
* Baliser les contenus en HTML AVANT même que le Design ne soit créé
...
Vérifier l'ordre et la disposition des contenus sur l'écran étroit avant d'ajouter au fur et à la mesure les variantes pour l'écran large.
...
selon la méthode BEM *adaptée* exemple du menu  
Voir le [Guide CSS](https://github.com/evefevrier/guide-developpement-web/blob/main/guide-css.md)
6. Architecture des fichiers CSS
voir cadriciel du guide de développement: 
* reset ou normalize, 
* utilitaires, 
...
### Intégration HTML
### Styles CSS
Notions de cascade, spécificité, modèles de boîte +ou- assimilées
Utilisation des flottants et des schèmes de positionnement +ou- assimilées
Flexbox 
CSS Grids 

### Accessibilité
                  notes de cours    exercices formatifs ou TPs
des contenus
des formulaires
de la navigation

### Introduction à Sass
Enrichissement méthode alternative pour optimiser les fichiers CSS
...
Méthode de base : autopréfixeur + cssminifier
